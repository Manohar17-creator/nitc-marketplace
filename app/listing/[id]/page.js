        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 mb-6 rounded-r-lg">
              ...
              <div className="text-4xl font-bold text-green-700">₹{listing.price.toLocaleString()}</div>
            </div>
            ...
            <div className="mb-6 pb-6 border-b">
              <h2 className="font-semibold text-gray-900 text-lg mb-3">Category</h2>
            ...
            <div>
              ...
              <a
                href={`tel:${listing.sellerPhone}`}
                className="block w-full mt-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 rounded-lg font-semibold text-center hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg hover:shadow-xl"
              >
                Contact Seller
              </a>
            </div>
