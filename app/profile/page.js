    ...
    <div className="overflow-x-hidden bg-gray-50">
      ...
      <main className="pt-[72px] pb-nav-safe  bg-gray-50 min-h-screen">
        <div className="max-w-6xl mx-auto px-4 mt-4 mb-4">
          ...
          {/* 3. NEW: Help & Support (Contact Page) */}
          <Link href="/contact">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-6 flex items-center justify-between hover:bg-gray-50 transition-colors cursor-pointer group">
              <div className="flex items-center gap-3">
                 ...
                 <div>
                    ...
                    <p className="text-xs text-gray-500">Contact us for any issues</p>
                 </div>
              </div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2">
                            ...
                            <span
                              className={`mt-2 sm:mt-0 self-center sm:self-auto px-2.5 py-1 rounded-full text-xs font-medium whitespace-nowrap ${listing.status === 'active'
